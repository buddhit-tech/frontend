...
export const mockArticles: Article[] = [
  ...
  {
    id: "2",
    title: "Zuckerberg says he'd rather 'misspend' billions than lose AI race",
    imageUrl:
...
export const mockMarketData: MarketData[] = [
  ...
  { name: "VIX", value: "15.45", change: "-1.59%", changeType: "negative" },
];

export const mockTrendingCompanies: TrendingCompany[] = [
  {
    name: "Amazon.com, Inc.",
    ticker: "AMZN",
    price: "$231.48",
